...
const vorAnmeldung = (await page.locator('.kopfzeile__version').innerText()).trim();
...
const kontext = (await page.locator('.kopfzeile__kontext').innerText()).trim();
...
await page.locator('.kopfzeile').screenshot({ path: `${OUT}/ver-2-kopfzeile.png` });
